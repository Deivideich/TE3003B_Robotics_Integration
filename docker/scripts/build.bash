...
# if image name is te3003, first build humble image
if [ "$ROS_DISTRO" == "te3003" ]; then
    HUMBLE_IMAGE_NAME="emilianh/ros:humble"
    HUMBLE_DOCKER_FILE="$PWD/docker/Dockerfile.humble"
    if [ -n "$USE_CUDA" ]; then
